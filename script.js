// Crear variables con datos de cada card
...
// Creación de Arrays para agregar datos al divContainer
let card01 = [image01, name01, description01];
let card02 = [image02, name02, description02];
let card03 = [image03, name03, description03];

// Funciones para hacer el hover de cada card

card01.forEach((card) => {
  divCard01.appendChild(card);

  card01[2].onmouseover = () => {
    card01[0].style.display = "inline-block";
    card01[2].style.display = "none";
    card01[1].style.display = "inline-block";
  };
  card01[0].onmouseover = () => {
    card01[0].style.display = "none";
    card01[2].style.display = "inline-block";
    card01[1].style.display = "none";
  };
});
...
card02.forEach((card) => {
  ...
  card02[2].onmouseover = () => {
    card02[0].style.display = "inline-block";
    card02[2].style.display = "none";
    card02[1].style.display = "inline-block";
  };
  card02[0].onmouseover = () => {
    card02[0].style.display = "none";
    card02[2].style.display = "inline-block";
    card02[1].style.display = "none";
  };
});
card03.forEach((card) => {
  divCard03.appendChild(card);

  card03[2].onmouseover = () => {
    card03[0].style.display = "inline-block";
    card03[2].style.display = "none";
    card03[1].style.display = "inline-block";
  };
  card03[0].onmouseover = () => {
    card03[0].style.display = "none";
    card03[2].style.display = "inline-block";
    card03[1].style.display = "none";
  };
});
